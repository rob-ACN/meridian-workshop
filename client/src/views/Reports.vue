    ...
    <div v-else>
          ...
          <table class="reports-table">
            ...
            <tbody>
              <tr v-for="(q, index) in quarterlyData" :key="index">
                ...
                <td>{{ formatAmount(q.total_revenue) }}</td>
                <td>{{ formatAmount(q.avg_order_value) }}</td>
                <td>
            ...
            <div v-for="(month, index) in monthlyData" :key="index" class="bar-wrapper">
              <div class="bar-container">
                <div
                  ...
                  :title="formatAmount(month.revenue)"
                ></div>
              </div>
          ...
          <table class="reports-table">
            ...
            <tbody>
              <tr v-for="(month, index) in monthlyData" :key="index">
                ...
                <td>{{ formatAmount(month.revenue) }}</td>
                <td>
      ...
      <div class="stats-grid">
        <div class="stat-card">
          ...
          <div class="stat-value">{{ formatAmount(totalRevenue) }}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">Avg Monthly Revenue</div>
          <div class="stat-value">{{ formatAmount(avgMonthlyRevenue) }}</div>
        </div>
        <div class="stat-card">
...
export default {
  ...
  setup() {
    ...
    const formatAmount = (num) =>
      formatCurrency(num, currentCurrency.value)
    ...
    const getChangeValue = (current, previous) => {
      ...
      const abs = formatCurrency(Math.abs(change), currentCurrency.value)
    ...
    return {
      ...
      formatAmount, formatMonth, getBarHeight,
