export default {
  ...
  restocking: {
    ...
    description: 'Purchase order recommendations based on stock levels, demand forecast, and your budget',
    budgetCeiling: 'Budget Ceiling',
    totalEstimatedSpend: 'Total estimated spend',
    remainingBudget: 'Remaining budget',
    itemsCovered: 'Items covered',
    recommendedOrders: 'Recommended Purchase Orders',
    noRestocking: 'No restocking needed',
    noRestockingBudget: 'No restocking needed within current budget',
